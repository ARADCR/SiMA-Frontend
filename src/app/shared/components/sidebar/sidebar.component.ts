...
export class SidebarComponent {
  ...
  private allNavItems: NavItem[] = [
    ...
    { label: 'Dispositivos',   icon: 'M17 1H7c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V3c0-1.1-.9-2-2-2zm0 18H7V5h10v14zm-5-4c.83 0 1.5-.67 1.5-1.5S12.83 12 12 12s-1.5.67-1.5 1.5S11.17 15 12 15z', route: '/admin/dispositivos',      roles: ['Administrador'] },
    ...
    { label: 'Alertas',        icon: 'M12 22c1.1 0 2-.9 2-2h-4c0 1.1.9 2 2 2zm6-6v-5c0-3.07-1.64-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.63 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2z', route: '/familiar/alertas',        roles: ['Familiar'] },
    // Cuidador
    ...
    { label: 'Registrar Toma', icon: 'M9 3L5 6.99h3V14h2V6.99h3L9 3zm7 14.01V10h-2v7.01h-3L15 21l4-3.99h-3z', route: '/cuidador/registrar-tomas',  roles: ['Cuidador'] },
    ...
    { label: 'Cumplimiento',   icon: 'M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 3c1.93 0 3.5 1.57 3.5 3.5S13.93 13 12 13s-3.5-1.57-3.5-3.5S10.07 6 12 6zm7 13H5v-.23c0-.62.28-1.2.76-1.58C7.47 15.82 9.64 15 12 15s4.53.82 6.24 2.19c.48.38.76.97.76 1.58V19z', route: '/cuidador/cumplimiento',   roles: ['Cuidador'] },
    // Adulto Mayor
    { label: 'Dashboard',      icon: 'M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z', route: '/adulto/dashboard',         roles: ['Adulto Mayor'] },
    { label: 'Recordatorios',  icon: 'M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm.5-13H11v6l5.25 3.15.75-1.23-4.5-2.67V7z', route: '/adulto/recordatorios',    roles: ['Adulto Mayor'] },
    { label: 'Chat',           icon: 'M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z', route: '/adulto/chatbot',           roles: ['Adulto Mayor'] },
    { label: 'Emergencia',     icon: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z', route: '/adulto/boton-emergencia', roles: ['Adulto Mayor'] },
  ];
